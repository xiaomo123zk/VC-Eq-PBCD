...
int main(int argc, char *argv[])
{
    ...
    {
        //.\v14_s08.exe 2 16 400 2 1 1 2 1 2 1 1 > CS_s08_omp16_para400_PBCD-VC-eq-2iGP-moreiGreedy.log
        int first_node = 1;
        PG_num_threads = number2; // omp_get_max_threads()
        PG_num_threads_else = PG_num_threads;
...
// ./Birm-VS-Eq-PBCD.exe 3 24 1600 3 8 2 1 1 1 1 1 1 1   