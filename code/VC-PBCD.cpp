...
int main(int argc, char *argv[])
{
    ...
    // Phi 1526; Birm 899; CS 1; Anaheim:39  
    if (number == 1) //  Anaheim
    {
        FIRST_THRU_NODE = 39;
...
// Build example:
// g++ -o Birm-VC-PBCD -std=c++11 -g .\VC-PBCD.cpp -fopenmp
//
// Run example:
// .\Birm-VC-PBCD.exe 3 8
//
// Argument meanings for the run example:
// argv[1] = 3: network selector. 1 = Anaheim, 2 = Chicago-Sketch,
//              3 = Birmingham, 4 = Philadelphia. In this example, 3 selects the
//              Birmingham network and loads F:\VC-Eq-PBCD\data\Birm with simName "08".
// argv[2] = 8: number of OpenMP threads used by the PBCD flow-adjustment stage.
//              The value is assigned to PG_num_threads and PG_num_threads_else.
